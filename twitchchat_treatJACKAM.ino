/*------------------------------------------------------------------------------
  10/20/2020
  Authors: Cisco • A C R O B O T I C | Edrig | JT | James Trevor | Van Robichaux
  Platforms: ESP32
  Language: C++/Arduino
  ...
  specific way—to control a SHARPER IMAGE Mini Automatic Touch-Activated Candy & Snack Dispenser.
  ()
  ------------------------------------------------------------------------------
  License:
